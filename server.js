...
// Configure CORS for Webflow
app.use(cors({
    origin: [
        'https://webflow-downloader.webflow.io/',    // Replace with your Webflow domain
...
app.post('/api/extract', async (req, res) => {
    ...
    try {
        ...
        res.status(500).json({
            ...
            message: process.env.NODE_ENV === 'development' ? error.message : 'An error occurred during extraction'
        });
    } finally {
